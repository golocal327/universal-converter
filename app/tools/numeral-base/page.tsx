...
import { NumeralBaseTool } from "@/components/tools/numeral-base-tool";
import { getTool } from "@/lib/content/tools";

const tool = getTool("numeral-base")!;

export const metadata: Metadata = {
  title: tool.name,
  description: tool.description,
  alternates: { canonical: "/tools/numeral-base" },
};

export default function NumeralBasePage() {
  return (
